...
// Public URL for the celebration background image (hosted by the user)
const CELEBRATION_BG_URL =
  "https://raw.githubusercontent.com/Ninad4251/rivuu-s-romantic-reverie/main/src/assets/celebration-bg.jpg";
...
const slides = [GALLERY_1_URL, GALLERY_2_URL, GALLERY_3_URL, GALLERY_4_URL];
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <img src={CELEBRATION_BG_URL} alt="Celebration background" className="w-full h-full object-cover" />
