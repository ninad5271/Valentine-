...
const GALLERY_1_URL =
  "https://raw.githubusercontent.com/ninad5271/rivuu-s-romantic-reverie/main/src/assets/IMG_0234.jpg";
const GALLERY_2_URL =
  "https://raw.githubusercontent.com/ninad5271/rivuu-s-romantic-reverie/main/src/assets/IMG_9659.jpg";
const GALLERY_3_URL =
...
const photos = [
  { src: GALLERY_1_URL, caption: "The moment I knew you were the one ❤️" },
  { src: GALLERY_2_URL, caption: "Holding your hand feels like home 🌹" },
  { src: GALLERY_3_URL, caption: "My heart belongs to you forever 💕" },
  { src: GALLERY_4_URL, caption: "Every night sky reminds me of your beauty ✨" },
];

const adorList = [
  "You’re sweeter than Maskabun — and that’s saying a lot 🍰✨",
  "My little cutie cat who makes my heart melt every single day 🐱💞",
  "No matter what outfit you wear, you always leave me completely stunned 😍",
  "Every picture I take is just an excuse to capture how beautiful you are 📸❤️",
  "Being with you feels like a beautiful dream 💭",
];

const cuteCards = [
  { emoji: "🍕", text: "The first and last bite will always be yours" },
  { emoji: "📹", text: "we’ll never stop our daily little vlogs together" },
  { emoji: "💞", text: "Our subscription to love? Auto-renewed forever and always" },
];

const quizQuestions = [
  {
    question: "What does Nini call riding vehicle?",
    options: ["Hakvu 🚗💕", "Drive 😎", "Ride 🏍️"],
    answer: 0,
    response: "Correct! You know Nini too well 😘💞",
  },
  {
