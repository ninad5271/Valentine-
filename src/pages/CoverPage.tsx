...
// Public URL for the hero background image — update this to your hosted URL if different
const HERO_BG_URL =
  "https://raw.githubusercontent.com/Ninad4251/rivuu-s-romantic-reverie/main/src/assets/hero-bg.jpg";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <img src={HERO_BG_URL} alt="Hero background" className="w-full h-full object-cover" />
